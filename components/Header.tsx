      ...
      <div className="fixed inset-0 md:hidden backdrop-blur-md">
        <div className="flex flex-col pt-20 items-center bg-white px-12 pb-8 space-y-4">
          ...
          <button 
            ...
            className="absolute top-5 right-10 text-gray-600 hover:text-blue-600"
          >
            <X className="h-6 w-6" />
          </button>
          ...
          {/* Mobile Properties */}
          <div className="py-2">
            <div className="flex items-center space-x-2 bg-blue-600 text-white px-2 py-1 rounded-md">
              <HomeIcon className="h-4 w-4" />
              <span>Book Any Guest House</span>
            </div>
