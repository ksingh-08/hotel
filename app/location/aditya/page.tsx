      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <h2 className="relative inline-block text-5xl font-extrabold text-gray-900 mb-6 tracking-tight leading-snug">
            <span className="relative z-10">Aditya Guest House Location</span>
          ...
          <p className="text-xl text-gray-700 max-w-2xl mx-auto leading-relaxed">
            Perfectly positioned in the vibrant heart of Mount Abu, offering seamless access to business districts and must-see attractions.
          </p>
        </motion.div>
...
export default AdityaLocationPage; 