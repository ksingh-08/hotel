...
export default function Home() {
  ...
  const rooms = [
    ...
    },
    {
      ...
      description:
        "Comfortable room with one queen bed, perfect for families or small groups traveling together.",
      price: "1500+",
      image: room,
      amenities: ["AC", "Free WiFi", "TV", "Room Service", "Work Desk"],
      type: "PREMIUM",
    ...
    },
    {
      ...
      description:
        "Cozy, budget-friendly room with all essential amenities for the solo traveler.",
      price: "1000+",
      image: bedroom,
  ...
  const faqs = [
    ...
    // },
    {
      ...
      answer:
        "Yes, complimentary breakfast is included with all room bookings. We serve continental and Indian breakfast options from 7:00 AM to 10:30 AM.",
    },
    {
      question: "What is your cancellation policy?",
      answer:
        "Free cancellation up to 48 hours before check-in. Cancellations within 48 hours of arrival may be subject to a one-night charge.",
    },
    {
      question: "Are pets allowed?",
      answer:
        "We regret that pets are not allowed in our guest house, with the exception of service animals.",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
      <Head>
        ...
        <meta
          name="description"
          content="Experience comfort and luxury at affordable prices at Aditya Guest House."
        />
      ...
      <section className="relative h-screen w-full overflow-hidden">
        ...
        <div className="absolute mt-12 inset-0 z-10 flex items-center justify-center px-4 text-center">
          <div className="max-w-4xl">
            ...
            >
              The premier destination for travelers seeking comfort and
              convenience in the serene hill station of Mount Abu, surrounded by
              breathtaking lakes and landscapes.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              ...
              <p className="text-gray-600">
                We treat each guest as family, offering personalized service and
                attention to make your stay special.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              ...
              <p className="text-gray-600">
                All rooms feature modern amenities including high-speed WiFi,
                air conditioning, and smart TVs.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-12">
            ...
            <p className="text-lg text-gray-700">
              ...
              offering the perfect balance of comfort and style.
            </p>
          </div>
      ...
      <section id="gallery" className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-12">
            ...
            <div className="h-1 w-20 bg-blue-600 mx-auto mb-8"></div>
            <p className="text-lg text-gray-700">
              Take a visual tour of our guest house facilities and experience
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {galleryImages.map((image, index) => (
              <div
                key={index}
                className="relative overflow-hidden group rounded-lg h-64"
              >
                <Image
                  src={image.src}
                  alt={image.label}
      ...
      <section id="amenities" className="py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-12">
            ...
            <div className="h-1 w-20 bg-blue-600 mx-auto mb-8"></div>
            <p className="text-lg text-gray-700">
              We offer a range of services and amenities to make your stay
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                ...
                description: "Featuring local and international cuisine",
              },
              {
                icon: "shield-alt",
                title: "24/7 Security",
              ...
              },
              {
                ...
                description: "On-call doctor and first aid",
              },
            ].map((item, index) => (
              <div
                key={index}
      ...
      <section id="faq" className="py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-12">
            ...
            <div className="h-1 w-20 bg-blue-600 mx-auto mb-8"></div>
            <p className="text-lg text-gray-700">
              Find answers to commonly asked questions about our guest house and
              services.
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="text-center md:text-left">
              ...
              <p className="text-blue-100">
                Get exclusive offers, updates, and travel tips delivered
