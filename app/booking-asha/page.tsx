              ...
              <>
                ...
                <div className="grid gap-4 max-w-2xl mx-auto">
                  {[
                    {
                      type: "Standard Room",
                      desc: "Queen bed, garden view, 28 sq.m",
                      price: "₹1,499",
                    ...
                    {
                      type: "Deluxe Room",
                      desc: "King bed, lake view, 35 sq.m",
                      price: "₹1,999",
                      tag: "Popular",
                      amenities: [
                        "Free WiFi",
                    ...
                    <li className="flex justify-between pt-2 text-blue-800 font-medium">
                      ...
                      <span>
                        {formData.roomType === "Standard Room"
                          ...
                          ? "₹1,999"
                          : formData.roomType === "Family Suite"
                          ? "₹2,999"
                          : "₹0"}{" "}
                        per night
                      </span>
            ...
            {[
              {
                ...
                location: "Delhi",
                comment:
                  "Beautiful location and excellent service. The staff was very helpful and friendly.",
                rating: 5,
              },
              {
                name: "Priya Patel",
                location: "Mumbai",
                comment:
                  "Perfect stay in Mount Abu. The rooms were clean and comfortable.",
                rating: 5,
              },
